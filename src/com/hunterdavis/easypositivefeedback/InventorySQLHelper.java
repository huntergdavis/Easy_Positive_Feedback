...
public class InventorySQLHelper extends android.database.sqlite.SQLiteOpenHelper {
	private static final String DATABASE_NAME = "positivefeedback.db";
	private static final int DATABASE_VERSION = 1;

	// Table name
	public static final String TABLE = "positivefeedback";
	...
	public void onCreate(SQLiteDatabase db) {
		String sql = "create table " + TABLE + "( " + BaseColumns._ID
				+ " integer primary key autoincrement, "+ MESSAGE + " text not null);";
		db.execSQL(sql);
	}
